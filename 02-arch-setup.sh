...
umount /mnt ;
mount -o defaults,noatime,nodiratime,compress=zstd:2,ssd,discard=async,space_cache=v2,autodefrag,subvol=@ $root_partition /mnt ;
mkdir -p /mnt/home ;
mount -o defaults,noatime,nodiratime,compress=zstd:2,ssd,discard=async,space_cache=v2,autodefrag,subvol=@home $root_partition /mnt/home ;
